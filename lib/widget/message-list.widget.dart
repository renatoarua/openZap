                ...
                ListTile(
                  trailing: IconButton(
                    ...
                    onPressed: () async {
                      ...
                      if(result)
                        SnackBarAlert.buildSnackBarSuccefull(context, "Mensagem deletada");
                      else
                        SnackBarAlert.buildSnackBarError(context, "Mensagem não deletada");
                    },
                  ),
                  title: Text(message.title.toString()),
                  subtitle: Text(message.text.toString(), style: TextStyle(fontSize: 12),),
